...
packer.startup(function(use)
    ...
    use {'tpope/vim-fugitive'} --Git version cotroll tool

    --LSP Server
    use {
        'williamboman/mason.nvim', --Mason UI Installer
        ...
        'jose-elias-alvarez/null-ls.nvim' --Use Neovim as a language server to inject LSP diagnostics,code action and more via Lua
    }
    ...
    --Multiple Cursors like Notpad++ feature
    use 'terryma/vim-multiple-cursors'
    
    --Easy and Quickly Search
...
--
  --          })
   ...
   -- })
    ...
    --Battery Monitoring combination with Lualine
    use {
